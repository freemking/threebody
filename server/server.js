...
const phoneticsRouter = require('./routes/phonetics');
...
app.listen(PORT, async () => {
    ...
    console.log(`字母组合接口: http://localhost:${PORT}/api/combinations`);
    console.log(`音标学习接口: http://localhost:${PORT}/api/phonetics`);
